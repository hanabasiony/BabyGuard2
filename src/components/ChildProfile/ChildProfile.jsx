...
import { Calendar, Bell, Plus, Info, Minus } from "lucide-react";
    ...
    return (
        ...
        <div className="w-full bg-white">
            ...
            <div className="p-4  py-40 md:p-8 max-w-7xl mx-auto space-y-6 md:py-40 sm:py-50">
                {/* <div className="flex">
                    <span className="text-xl text-black"> You have {childData?.length} Registered child : </span>
                ...
                <div className="flex flex-col md:flex-row items-center justify-between p-6  rounded-2xl shadow bg-white">
                    <div className="flex items-center space-x-4">
                        ...
                        <div>
                            <h2 className="text-xl font-semibold">{childData[0]?.name}</h2>
                            <p className="text-sm text-gray-500">
                                Age: {childData[0]?.birthDate ? calculateAge(childData[0].birthDate) : "N/A"}  &bull; Gender: {childData[0]?.gender}  &bull;  Blood type: {childData[0]?.bloodType}
                            </p>
                        </div>
                    </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                    ...
                    <div className="bg-white p-4 rounded-2xl shadow flex flex-col gap-4">
                        ...
                        <button onClick={() => navigate('/add-child')} className=" m-auto cursor-pointer flex w-full items-center justify-center px-4 py-2 bg-green-100 text-green-600 rounded hover:bg-green-200">
                            <Plus className="w-4 h-4 mr-2" /> Add Child
                        </button>

                        <button onClick={() => navigate('/')} className=" m-auto cursor-pointer flex w-full items-center justify-center px-4 py-2 bg-red-100 text-red-600 rounded hover:bg-red-200">
