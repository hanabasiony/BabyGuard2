...
const Sidebar = () => {
  ...
  return (
    <>
      ...
      {/* Mobile menu overlay */}
      <div
        className={`lg:hidden fixed inset-0 bg-gray-600 bg-opacity-75 z-40 transition-opacity duration-300 ${isMobileMenuOpen ? "opacity-100" : "opacity-0 pointer-events-none"
          }`}
      ...
      {/* Sidebar */}
      <div
        className={`lg:static fixed inset-y-0 left-0 w-64 bg-white shadow-md transform transition-transform duration-300 ease-in-out z-50 ${isMobileMenuOpen ? "translate-x-0" : "-translate-x-full lg:translate-x-0"
          }`}
      >
