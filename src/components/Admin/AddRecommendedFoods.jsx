        ...
        {({ isSubmitting, setFieldValue }) => (
          <Form className="max-w-md mx-auto px-4 sm:px-8">
            <div className="bg-white rounded-lg shadow-lg p-6">
              <h2 className="text-2xl font-semibold text-gray-800 mb-6 text-center">Add Recommended Food</h2>
              ...
              <div className="relative z-0 w-full mb-5 group">
                <Field
                  ...
                  placeholder=" "
                />
                <label htmlFor="name" className="peer-focus:font-medium absolute text-sm text-gray-500 duration-300 transform -translate-y-6 scale-75 top-3 -z-10 origin-[0] peer-focus:start-0 peer-focus:text-sky-400 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-6">
                  Food Name
                </label>
                <ErrorMessage
                  name="name"
              ...
              <div className="relative z-0 w-full mb-5 group">
                <div className="flex justify-center items-center w-full">
                  <label htmlFor="image" className="w-1/2 mb-2 text-sm font-medium text-gray-900">
                    Food Image
                  </label>
                  <input
                    type="file"
