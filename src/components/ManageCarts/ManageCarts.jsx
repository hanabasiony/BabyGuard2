...
import { User, Package, ArrowRight, Search, Filter, ChevronLeft, ChevronRight, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
const ManageCarts = () => {
    ...
    const filterUsers = () => {
        ...
        if (statusFilter !== 'all') {
            filtered = filtered.filter(user => 
                user.user.carts[0]?.status === statusFilter
            );
        }
                    ...
                    >
                        ...
                        <div className="space-y-3">
                            ...
                            <div className="flex items-center justify-between text-sm">
                                ...
                                <span className="font-medium">{userData.user.carts.length}</span>
                            </div>
