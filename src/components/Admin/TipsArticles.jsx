...
import { Info, Heart, Leaf, Smile, Trash2, Plus } from "lucide-react";
    ...
    <div className="py-10">
      <div className="p-4 max-w-6xl mx-auto space-y-6">
        ...
        <div className="bg-white p-6 rounded-2xl shadow flex items-center justify-between">
          <div>
            <h1 className="text-2xl font-semibold text-gray-800">Pregnancy Tips Management</h1>
            <p className="text-sm text-gray-500">Add or remove pregnancy tips and information</p>
          </div>
          <div className="flex items-center space-x-3">
            <button onClick={()=> navigate('choose-from-four')} className="bg-pink-500 hover:bg-pink-600 text-white px-4 py-2 rounded-lg transition-colors duration-200 flex items-center space-x-2">
              <span>Add New</span>
              <Plus className="w-4 h-4" />
            </button>
            <button className="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-lg transition-colors duration-200 flex items-center space-x-2">
              <span>Delete</span>
