...
const yourValidationSchema = yup.object().shape({
  ...
  city: yup.string().required("city must have a value"), // Changed from notEmpty to required

  governorate: yup.string().required("gov must have a value"), // Changed from notEmpty to required

  district: yup.string().required("district must have a value"), // Changed from notEmpty to required
