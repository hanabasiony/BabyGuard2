...
export default function Reg() {
    ...
    return (
        <div className="min-h-screen bg-white-50 pt-26 pb-12">
            <form className="max-w-6xl mx-auto px-4 sm:px-8" onSubmit={regFormik.handleSubmit}>
                {succMsg && (
                ...
                <div className="bg-white rounded-lg shadow-lg p-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div className="space-y-4">
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.fName && regFormik.touched.fName ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.fName}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.lName && regFormik.touched.lName ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.lName}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.email && regFormik.touched.email ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.email}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.nationalIdNumer && regFormik.touched.nationalIdNumer ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.nationalIdNumer}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.birthDate && regFormik.touched.birthDate ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.birthDate}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.password && regFormik.touched.password ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.password}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.passwordConfirm && regFormik.touched.passwordConfirm ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.passwordConfirm}</div> : ''}
                            </div>
                        </div>
                        ...
                        <div className="space-y-4">
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.phoneNumber && regFormik.touched.phoneNumber ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.phoneNumber}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.governorate && regFormik.touched.governorate ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.governorate}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.city && regFormik.touched.city ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.city}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.street && regFormik.touched.street ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.street}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.buildingNumber && regFormik.touched.buildingNumber ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.buildingNumber}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                ...
                                {regFormik.errors.apartmentNumber && regFormik.touched.apartmentNumber ? <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.apartmentNumber}</div> : ''}
                            </div>
                            ...
                            <div className="relative z-0 w-full group">
                                <div className="flex gap-4">
                                    <div className="flex items-center">
                                        <input
                                            ...
                                            className="w-4 h-4 text-rose-300 bg-gray-100 border-gray-300 focus:ring-rose-350"
                                        />
                                ...
                                {regFormik.errors.gender && regFormik.touched.gender ? (
                                    <div className="p-2 mt-1 text-sm text-red-800 rounded-lg bg-red-50" role="alert">{regFormik.errors.gender}</div>
                                ) : ''}
                            </div>
                        </div>
                    </div>
                    ...
                    <div className='flex justify-between w-full items-center mt-6'>
                        <button type="submit" className="text-white bg-rose-300 hover:bg-rose-400 cursor-pointer hover:bg-rose-350 focus:ring-4 focus:outline-none focus:ring-rose-350 font-medium rounded-lg text-sm sm:w-auto px-5 py-2.5 text-center">{loading ? 'Loading..' : 'Register'}</button>
                        <Link to='/login' className='text-sm text-rose-350 hover:underline'>Have an account?</Link>
                    </div>
                </div>
            </form>
        </div>
