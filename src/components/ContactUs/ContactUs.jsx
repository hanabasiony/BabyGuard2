        ...
        <div className="min-h-screen bg-white flex flex-col items-center justify-center px-4 py-35">
            <div className="max-w-5xl w-full grid md:grid-cols-2 gap-10 items-center">
                ...
                <div className="space-y-6">
                    <h2 className="text-3xl font-bold" style={{ color: '#8BCFE0' }}>
                ...
                <div className="flex flex-col items-center space-y-6">
                    ...
                    <div className="space-y-4 text-center md:text-left">
                        <div className="flex items-center gap-2 text-gray-600">
                            <i className="fa-solid fa-phone" style={{ color: '#8BCFE0' }}></i>
                            <span>+20 123 456 789</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-600">
                            <i className="fa-solid fa-location-dot" style={{ color: '#8BCFE0' }}></i>
                            <span>Cairo, Egypt</span>
                        </div>
                        <div className="flex items-center gap-2 text-gray-600">
                            <i className="fa-solid fa-envelope" style={{ color: '#8BCFE0' }}></i>
                            <span>info@babyguard.com</span>
                        </div>
                        <div className="flex gap-7 pt-4 text-blue-600 text-xl">
                            <a href="#"><i className="fab fa-facebook-f" style={{ color: '#8BCFE0' }}></i></a>
                            <a href="#"><i className="fab fa-twitter" style={{ color: '#8BCFE0' }}></i></a>
                            <a href="#"><i className="fab fa-instagram" style={{ color: '#8BCFE0' }}></i></a>
                        </div>
                    </div>
                </div>
            </div>
