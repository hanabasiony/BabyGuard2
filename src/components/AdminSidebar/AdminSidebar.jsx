...
//     <a
//       href="#"
//       className={`flex items-center gap-3 px-3 py-3 rounded-md text-sm font-medium transition-colors ${active ? "bg-blue-100 text-blue-900" : "text-blue-800 hover:bg-blue-100 hover:text-blue-900"
//         }`}
//     >
