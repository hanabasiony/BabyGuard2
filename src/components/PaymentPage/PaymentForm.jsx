...
export default function PaymentForm() {
  ...
  const validateForm = () => {
    ...
    if (formData.expiryMonth && formData.expiryYear) {
      ...
      if (expiryDate < today) {
        newErrors.expiryYear = newErrors.expiryMonth =
    ...
    <div className="min-h-screen bg-gray-100 py-10 px-4 sm:px-6 lg:px-8 flex items-center justify-center">
      <div className="max-w-md w-full bg-white p-8 rounded-xl shadow-lg space-y-6">
        ...
        <div className="flex justify-between items-center border-b pb-4">
          ...
          <div className="text-blue-600 text-3xl font-bold italic">
            VISA
          </div>{" "}
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <input
                ...
                } rounded-md shadow-sm focus:outline-none focus:ring-rose-400 focus:border-rose-400 sm:text-sm`}
              />
            ...
            <div>
              ...
              <input
                ...
                } rounded-md shadow-sm focus:outline-none focus:ring-rose-400 focus:border-rose-400 sm:text-sm tracking-wide`}
            ...
            <div className="grid grid-cols-3 gap-4">
              <div className="col-span-1">
                ...
                <select
                  ...
                  } rounded-md shadow-sm focus:outline-none focus:ring-rose-400 focus:border-rose-400 sm:text-sm appearance-none cursor-pointer`}
                >
